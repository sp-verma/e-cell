...
export default function StickyScrollRevealDemo() {
  return (
    <div className="p-10 flex flex-col gap-10 h-screen bg-[rgb(20,30,40)]">
      <h1 className="text-center text-5xl font-bold font-serif text-white opacity-100">
        Events
      </h1>
      <StickyScroll content={content} />
      <div className="flex justify-center">
        <button className="mt-6 px-8 py-2 bg-[rgb(0,122,255)] text-white text-xl rounded-lg hover:bg-[rgb(0,90,190)] transition-all duration-300">
          Know More
        </button>
      </div>
    </div>
